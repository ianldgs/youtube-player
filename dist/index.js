...
exports.inspectOpts = Object.keys(browser$1.env).filter(function (key) {
...
var fd = parseInt(browser$1.env.DEBUG_FD, 10) || 2;

if (1 !== fd && 2 !== fd) {
  util.deprecate(function(){}, 'except for stderr(2) and stdout(1), any other usage of DEBUG_FD is deprecated. Override debug.log if you want to use a different log function (https://git.io/debug_fd)')();
}

var stream = 1 === fd ? browser$1.stdout :
             2 === fd ? browser$1.stderr :
...
function createWritableStdioStream (fd) {
  var stream;
  var tty_wrap = browser$1.binding('tty_wrap');
...
if (typeof browser$1 !== 'undefined' && browser$1.type === 'renderer') {
